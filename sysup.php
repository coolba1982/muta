...
if ($act === 'upload') {
    ...
    if (isset($_FILES["upfile"]) && ($_FILES["upfile"]["name"] != '')) {
        ...
        //          clear($absolute_file);forward_view('sysup_iframe.php');
        // }
        ...
        if (!is_test()) {
            ...
            if (trim($str_xml) != "") {
               ...
               // $message = get_i18n('固件升级成功', 'Success to upgrade firmware');
                $msg = array('type' => 1, 'content' => 'OK');
                //clear($absolute_file);
                forward_view_not_exit('sysup_iframe.php');
                //flush();
                //Node_update('SF_MAIN', $absolute_file, UCT_UPDATE);
                exit;
            }
