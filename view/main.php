    ...
    <div class="span10">
        <div class="widget">
            <!--div class="widget-header">
                <h3><?php printx('接入互联网','Internet Access') ?>
            ...
            <div class="widget-content">
                ...
                <div id='access_nset'>
                    <div class="alert alert-error">
                        <button type="button" class="close" onclick='javascript:$("#access_nset").hide()'>&times;</button>
                        <!--h4><?php printx('注意','Attention') ?></h4-->


                        <?php printx('您需要设置一种接入方式，这样的您的手机或者PC才可以访问互联网' , 'You should config an connection type to make your terminal to access Internet') ?>
                    </div>
                </div>
                        ...
                        <div class="plan-container">
                            <div class="plan">
                                ...
                                <div class="plan-features" style="padding:20px;">
                                    ...
                                    <div>
                                        ...
                                        <div style="width:150px; height:220px; float:left; _margin-right:-3px;">
                                            ...
                                            <p><span class="help-icon"  id='help_wan'> </span></p>
                                ...
                                <?php  }  ?>
                                    ...
                                    <div>
                                        <button id='btn_waset' type="submit"
                                ...
                                <div class="plan-actions">
                                    <!--a href="#" class="btn"> 有线设置 </a-->
                                    <!--button type="submit" class="btn btn-primary">有线设置</button-->
                                ...
                                <div class="plan-features" style="padding:20px;">
                                    ...
                                    <div>
                                        ...
                                        <div style="width:150px; height:220px; float:left; _margin-right:-3px;">
                                            ...
                                            <p><span class="help-icon"  id='help_3g'> </span></p>
...
<div class="widget-content">
    ...
    <div id='wifi_nset'>
        <div class="alert alert-error">
            <button type="button" class="close" onclick='javascript:$("#wifi_nset").hide()'>&times;</button>
            <!--h4><?php printx('注意','Attention') ?></h4-->


            <?php printx('您需要设置WIFI,这样您的手机或者PC可以通过WIFI网络连接到路由器', 'You should connect PC or mobile phone with the router by use of WIFI') ?>
        </div>
    </div>
                    ...
                    <div class="plan-features" style="padding:20px;">
                            ...
                            <div>
                                ...
                                <div style="width:150px; height:150px; float:left; _margin-right:-3px;">
                                    ...
                                    <p><span class="help-icon"  id='help_wifi'> </span></p>
                    ...
                    <div class="plan-features" style="padding:20px;">
                        ...
                        <div>
                            ...
                            <div style="width:150px; height:150px; float:left; _margin-right:-3px;">
                                ...
                                <p><span class="help-icon"  id='help_share'> </span></p>
        ...
        <div class="widget">
            ...
            <div class="widget-content">
                <ul>
                    ...
                    <li class="hli"><img src="res/img/ly.jpg" alt="" style="width:124px;height:148px;"/></li>

                    <li class="hli"><b><?php printx('设备型号:', 'Device Type:') ?>&nbsp;&nbsp;</b> <span
                            id='sys_type'></span></li>
                    <li class="hli"><b><?php printx('固件版本:', 'Firmware Version:') ?>&nbsp;&nbsp;</b><span
                            id='sys_version'></span></li>
                    <li class="hli"><b><?php printx('运行时长:', 'Run Time:') ?>&nbsp;&nbsp;</b><span id='sys_time'></span>
                    </li>
                    <li class="hli"><b><a href="inter.php"><span
                                    class="badge badge-info"><?php printx('接口信息总览', 'Interface Info') ?></span></a>&nbsp;&nbsp;
                        </b></li>
                    <li class="hli">
...
function  show_u_stat(obj){
	 ...
	 if ((obj==null)||(obj.u_stat==null)) {
        u.removeClass().addClass('font-red').html('<?php printx('未插入U盘','Flash disc not inserted')?>');
