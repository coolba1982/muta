                    ...
                    <div class="span10">
                        <div class="widget">
                            ...
                            <div class="widget-content"  style='padding:0px;'>
                                ...
                                <iframe src='sysup.php?act=iframe' id="frame"  name="frame" style="width:100%;height:100%;border:none;"   frameborder="no" border="0" >
...
function submit(){  
    	  try{
             ...
             confirm('<?php printx('是否确定上传?','Are you sure to upload?') ?>' ,upload_form) ;
        }catch(e){alert(e);} 	 	   
...
function   upload_form(){
           ...
           var is_finished = function(){
           	 ...
           	 if( $(window.frames["frame"].document).find("#finish_tag").val()=='true'){
                   ...
                   if($(window.frames["frame"].document).find("#status").val()=='OK'){
                       var file = $(window.frames["frame"].document).find("#file_path").val();
                       window.location.href = 'upgrading.php?fpath='+file;
                   }
           	 }
          }
